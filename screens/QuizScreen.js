...
import questions from "../data/GKquestions";
...
const QuizScreen = () => {
  ...
  return (
    <SafeAreaView style={{ backgroundColor: "#372780" }}>
      <View>
      ...
      >
        <Text Style={styles.points}>Your Points: {points * 10}</Text>
        <Pressable
          style={{
            backgroundColor: "#C200E1",
            borderRadius: 30,
            borderWidth: 5,
            borderColor: "#2BC5EE",
            width: 50,
...
const styles = StyleSheet.create({
  ...
  points: {
    fontFamily: "Poppins_400Regular", // Use Poppins regular font
    fontSize: 16,
    color: "white",
    // Additional styles for your points text
  },
});
